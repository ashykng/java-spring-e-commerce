...
[![npm version](https://badge.fury.io/assets/js/vazir-font.svg)](https://badge.fury.io/assets/js/vazir-font)
...
#### Arch Linux
Arch user's could use [vazir-fonts](https://aur.archlinux.org/packages/vazir-assets/fonts/) package from [AUR](https://aur.archlinux.org/) repository to install vazir font.
